...
export default class App {
    ...
    showMainContent() {
        // const mainContainer = document.getElementById('main-container');
         const heroLoaderElement = document.getElementById('hero-loader'); // Get hero loader
        if (heroLoaderElement) {
            heroLoaderElement.style.display = 'none'; // Hide loader element MANUALLY
        }
